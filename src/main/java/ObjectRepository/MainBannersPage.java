...
public class MainBannersPage {

	@FindBy(xpath ="//a[@href='/banners/main-banner']")private WebElement MainBannersLink;
	
	@FindBy(xpath ="//input[@placeholder='Search...']")private WebElement SearchEdt;
	
	@FindBy(xpath ="//button[@class='btn btn-added']")private WebElement AddMainBannersBtn;
	...
	public void MainBanners(String fromdate,String todate,String uploadbannerimage,String sequence,String search) throws Exception
	{
		MainBannersLink.click();
		Thread.sleep(2000);
		AddMainBannersBtn.click();
		Thread.sleep(2000);
